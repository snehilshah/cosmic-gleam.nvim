...
if vim.g.cosmic_gleam_enable_font_variants == true or vim.g.cosmic_gleam_enable_font_variants == nil then
  ...
  undercurl = true
  strikethrough = true
elseif type(vim.g.cosmic_gleam_enable_font_variants) == 'table' then
  --- Enable only selected font attributes
  bold = vim.g.cosmic_gleam_enable_font_variants.bold
  italic = vim.g.cosmic_gleam_enable_font_variants.italic
  underline = vim.g.cosmic_gleam_enable_font_variants.underline
  undercurl = vim.g.cosmic_gleam_enable_font_variants.undercurl
