...
vim.b.lightline_cosmic_gleam_palette = require("cosmic_gleam/palettes/" .. variant)
EOF
let s:grays = b:lightline_cosmic_gleam_palette.a
let s:bright = b:lightline_cosmic_gleam_palette.b
let s:normal = b:lightline_cosmic_gleam_palette.c
...
let g:lightline#colorscheme#cosmic_gleam#palette = lightline#colorscheme#flatten(s:p)
